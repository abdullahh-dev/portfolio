  ...
  return (
    <nav>
      <div
        ...
        className="bottom-[4%] z-[1000] flex fixed cst-md:hidden flex-col p-1 outline outline-1 outline-offset-0 outline-[#151515] right-[2%] overflow-hidden  backdrop-blur-[2px]"
      >
        <div
